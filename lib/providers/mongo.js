...
(function() {
  ...
  Mongo = (function() {
    ...
    Mongo.prototype.enableRpc = function() {
      var manager, managerName, method, methodName, _ref, _results;
      _ref = this._managers;
      _results = [];
          ...
          for (methodName in manager) {
            ...
            if (typeof method === 'function') {
              _results1.push((function(_this) {
                return function(managerName, methodName, manager) {
                  return server.expose("" + _this._group + "." + managerName + "." + methodName, function() {
                    return manager[methodName].apply(manager, arguments);
                  });
                };
              })(this)(managerName, methodName, manager));
            } else {
