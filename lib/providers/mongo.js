...
(function() {
  var Manager, Mongo, Server, mongoose;
  ...
  Mongo = (function() {
    ...
    Mongo.prototype.bind = function(port) {
      if (!this._isBound) {
      ...
      if (!this._isRpcEnabled) {
        ...
        for (managerName in _ref) {
          ...
          for (methodName in manager) {
            ...
            if (typeof method === 'function' && methodName.indexOf('_') !== 0) {
    ...
    Mongo.prototype._bindRpcMethods = function(managerName, methodName, manager) {
      ...
      return this._server.expose(eventName, function() {
